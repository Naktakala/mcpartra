--G=168
--Fixed source g=0
--MonteCarlo solution and LBS solution
chiMPIBarrier()
...
vol1 = chiLogicalVolumeCreate(RPP,-1000,1000,-1000,1000,-1000,1.0)
chiVolumeMesherSetProperty(MATID_FROMLOGICAL,vol1,1)



--############################################### Setup MonteCarlo mesh
