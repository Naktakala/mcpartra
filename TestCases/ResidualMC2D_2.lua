...
vol1 = chiLogicalVolumeCreate(RPP,-1000,1000,-1000,2.5,-1000,1000)
...
--Total source volume
chiMonteCarlonSetProperty(phys1,MCProperties.TALLY_MULTIPLICATION_FACTOR,5.0*2.5)
...
chiMonteCarlonSetProperty(phys2,MCProperties.NUM_UNCOLLIDED_PARTICLES,0.5e6)
chiMonteCarlonSetProperty(phys2,MCProperties.NUM_PARTICLES,0.5e6)
...
--Total surface area = 5.0*4
chiMonteCarlonSetProperty(phys2,MCProperties.TALLY_MULTIPLICATION_FACTOR,5.0)
...
chiFFInterpolationSetProperty(cline0,LINE_FIRSTPOINT,2.5+0.3125,0.0+xmin,0.0)
chiFFInterpolationSetProperty(cline0,LINE_SECONDPOINT,2.5+0.3125, 5.0+xmin,0.0)
...
chiFFInterpolationSetProperty(cline0,ADD_FIELDFUNCTION,fflist1[1])
...
chiFFInterpolationSetProperty(cline,LINE_FIRSTPOINT,2.5+0.3125,0.0+xmin,0.0)
chiFFInterpolationSetProperty(cline,LINE_SECONDPOINT,2.5+0.3125, 5.0+xmin,0.0)
