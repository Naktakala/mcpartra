...
chiMonteCarlonCreateSource(phys1,MCSrcTypes.BNDRY_SRC,6);
...
chiMonteCarlonSetProperty(phys1,MCProperties.TALLY_MULTIPLICATION_FACTOR,0.25)
...
chiMonteCarlonCreateSource(phys2,MCSrcTypes.RESIDUAL,6,fflist0[1],0.5);
