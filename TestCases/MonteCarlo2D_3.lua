...
chiMonteCarlonSetProperty(phys1,MCProperties.TALLY_MULTIPLICATION_FACTOR,2.0)
...
chiFFInterpolationSetProperty(cline,LINE_FIRSTPOINT,-0.001,-1.0, 0.0)
chiFFInterpolationSetProperty(cline,LINE_SECONDPOINT,-0.001,1.0, 0.0)
