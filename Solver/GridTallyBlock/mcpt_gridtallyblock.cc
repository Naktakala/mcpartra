#include "mcpt_gridtallyblock.h"

//###################################################################
/**Resizes all the underlying data structures.*/
void mcpartra::GridTallyBlock::Resize(size_t tally_size)
{
...
//###################################################################
/**Assignment operator.*/
mcpartra::GridTallyBlock& mcpartra::GridTallyBlock::
  operator=(const GridTallyBlock& that)
{
...
void mcpartra::GridTallyBlock::ZeroOut()
{
